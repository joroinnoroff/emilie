...
const messages = {
  en: {
    ...
    "shop.printsAvailable": "Prints available",
    "shop.offerBoth": "Original · Prints available",
  ...
  nb: {
    ...
    "shop.printsAvailable": "Trykk tilgjengelig",
    "shop.offerBoth": "Original · Trykk tilgjengelig",
    "shop.offerOriginal": "Original",
